...
public final class AComparisonMorecomparison extends PMorecomparison
{
    private PComparison _comparison_;

    public AComparisonMorecomparison()
    {
    }
    ...
    public Object clone()
    {
        return new AComparisonMorecomparison(
            (PComparison) cloneNode(_comparison_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAComparisonMorecomparison(this);
    }
