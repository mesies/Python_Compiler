...
public final class AComparisonexMorecomparison extends PMorecomparison
{
    private PExpression _exp1_;
    private PExpression _exp2_;

    public AComparisonexMorecomparison()
    {
    }
    ...
    public Object clone()
    {
        return new AComparisonexMorecomparison(
    ...
    {
        ((Analysis) sw).caseAComparisonexMorecomparison(this);
    }
