...
public final class ACommandsProgramme extends PProgramme
{
    private final LinkedList _commands_ = new TypedLinkedList(new Commands_Cast());

    public ACommandsProgramme()
    {
    }
    ...
    public Object clone()
    {
        return new ACommandsProgramme(
            cloneList(_commands_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseACommandsProgramme(this);
    }
    ...
    private class Commands_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != ACommandsProgramme.this))
            {
