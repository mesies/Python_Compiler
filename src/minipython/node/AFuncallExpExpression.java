...
public final class AFuncallExpExpression extends PExpression
{
    private PCallfuncall _callfuncall_;

    public AFuncallExpExpression()
    {
    }
    ...
    public Object clone()
    {
        return new AFuncallExpExpression(
            (PCallfuncall) cloneNode(_callfuncall_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFuncallExpExpression(this);
    }
